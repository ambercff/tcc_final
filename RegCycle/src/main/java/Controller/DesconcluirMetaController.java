...
@WebServlet("/DesoncluirMetaController")
public class DesconcluirMetaController extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		boolean concluiu = regcycleDAO.desconcluirMeta(id, usuario.getUsername());
